...
// import {SignInUsingEmailAndPassword} from "../firebase/auth"
    ...
    <div className='loginbox'>
      ...
      <form onSubmit={login}>
        ...
        <div className="inputForm">
          ...
          <input type="email" name="email"className="input" placeholder="Enter your Email" value={user.email} onChange={handleInput}/>
        </div>
        <br />
        <div className="flex-column">
        ...
        <div className="inputForm">
          ...
          <input type="password" name="password" className="input" placeholder="Enter your Password" value={user.password} onChange={handleInput}/>
        ...
        <p className="p">Don't have an account? <NavLink to={"/signup"}><span className="span">Sign Up</span></NavLink></p>
